HW1_(i)_and_(iii): 1.jpg ~ 10.jpg are the first part of the Basic Prime Testing and Fermat Primality Testing displaying pictures. To show the realation between input size(bits) n and running time, for all i.jpg, i starts from 1 to 30, means the test integer n is represented by 2^(i), or it has (i+1) bits.
